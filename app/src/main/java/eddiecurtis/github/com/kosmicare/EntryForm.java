...
public class EntryForm extends ActionBarActivity
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        private void loadFormData() {
            ...
            setCheckBox(R.id.check_effective_listening, data.isTechniqueEffectiveListening());
            setCheckBox(R.id.check_ineffective_listening, data.isTechniqueIneffectiveListening());
            setCheckBox(R.id.check_effective_talking, data.isTechniqueEffectiveTalking());
            setCheckBox(R.id.check_ineffective_talking, data.isTechniqueIneffectiveTalking());
            setCheckBox(R.id.check_effective_hugging, data.isTechniqueEffectiveHugging());
            setCheckBox(R.id.check_ineffective_hugging, data.isTechniqueIneffectiveHugging());
            setCheckBox(R.id.check_effective_sitting, data.isTechniqueEffectiveSitting());
            setCheckBox(R.id.check_ineffective_sitting, data.isTechniqueIneffectiveSitting());
            setCheckBox(R.id.check_effective_holding_hands, data.isTechniqueEffectiveHoldingHands());
            setCheckBox(R.id.check_ineffective_holding_hands, data.isTechniqueIneffectiveHoldingHands());
            setCheckBox(R.id.check_effective_creative_therapy, data.isTechniqueEffectiveCreativeTherapy());
            setCheckBox(R.id.check_ineffective_creative_therapy, data.isTechniqueIneffectiveCreativeTherapy());
            setCheckBox(R.id.check_effective_left_alone, data.isTechniqueEffectiveLeftAlone());
            setCheckBox(R.id.check_ineffective_left_alone, data.isTechniqueIneffectiveLeftAlone());
            setCheckBox(R.id.check_effective_other, data.isTechniqueEffectiveOther());
            setCheckBox(R.id.check_ineffective_other, data.isTechniqueIneffectiveOther());
    ...
    public FormData getFormData() {
        ...
        data.setTechniqueEffectiveListening(checkBoxSelected(R.id.check_effective_listening));
        data.setTechniqueIneffectiveListening(checkBoxSelected(R.id.check_ineffective_listening));
        data.setTechniqueEffectiveTalking(checkBoxSelected(R.id.check_effective_talking));
        data.setTechniqueIneffectiveTalking(checkBoxSelected(R.id.check_ineffective_talking));
        data.setTechniqueEffectiveHugging(checkBoxSelected(R.id.check_effective_hugging));
        data.setTechniqueIneffectiveHugging(checkBoxSelected(R.id.check_ineffective_hugging));
        data.setTechniqueEffectiveSitting(checkBoxSelected(R.id.check_effective_sitting));
        data.setTechniqueIneffectiveSitting(checkBoxSelected(R.id.check_ineffective_sitting));
        data.setTechniqueEffectiveHoldingHands(checkBoxSelected(R.id.check_effective_holding_hands));
        data.setTechniqueIneffectiveHoldingHands(checkBoxSelected(R.id.check_ineffective_holding_hands));
        data.setTechniqueEffectiveCreativeTherapy(checkBoxSelected(R.id.check_effective_creative_therapy));
        data.setTechniqueIneffectiveCreativeTherapy(checkBoxSelected(R.id.check_ineffective_creative_therapy));
        data.setTechniqueEffectiveLeftAlone(checkBoxSelected(R.id.check_effective_left_alone));
        data.setTechniqueIneffectiveLeftAlone(checkBoxSelected(R.id.check_ineffective_left_alone));
        data.setTechniqueEffectiveOther(checkBoxSelected(R.id.check_effective_other));
        data.setTechniqueIneffectiveOther(checkBoxSelected(R.id.check_ineffective_other));
